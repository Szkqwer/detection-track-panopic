...
class YOLO_COCO_BDD(object):
    _defaults = {
        "model_path": 'model_data/weights_coco_bdd4.h5',
        "classes_path": 'model_data/coco_bdd_class.txt',
        "anchors_path": 'model_data/coco_bdd_anchors.txt',
    ...
    #   检测图片
    #---------------------------------------------------#
    def detect_image(self, image,aim_w,aim_h):
        ...
        out_boxes, out_scores, out_classes = self.sess.run(
            ...
            feed_dict={
                ...
                self.input_image_shape: [aim_h, aim_w],
                K.learning_phase(): 0
            })
        ...
        for i, c in list(enumerate(out_classes)):
            ...
            # 在使用coco_bdd时
            #交通牌置信度需大于0.65
            # if c == 8 and score < 0.6:
            #     continue
            # #信号灯
            # if c == 6 and score < 0.6:
            #     continue
            # #bus
            # if c == 4 and score < 0.6:
            #     continue
